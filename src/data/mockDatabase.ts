...
export const INITIAL_TICKETS: SupportTicket[] = [
  {
    ...
    userId: 'usr_002',
    userName: 'suporte.nanucloud',
    userEmail: 'suporte@nanucloud.com',
...
export const INITIAL_CLIENTS: UserSafe[] = [
  {
    id: 'cli_001',
    name: 'Dr. Paulo Klayton Monteiro',
    email: 'monteiro.comercial@gmail.com',
    ...
    assignedManagerName: 'Carlos Manuel',
    isActive: true,
    ...
    commercialNotes: 'Cliente estratégico de grande porte com armazéns em Luanda e Benguela.',
  ...
  },
  {
    ...
    commercialNotes: 'Rede de 6 farmácias. Utiliza simulação para cálculo de margens e PVP de medicamentos.',
  ...
  },
  {
    ...
    assignedManagerName: 'Dra. Teresa Bento',
    isActive: true,
    ...
    isBatchUnlocked: true,
    isApiUnlocked: true,
    commercialNotes: 'Despachante oficial no Porto de Luanda. Integração via API REST com software próprio.',
  ...
  },
  {
    ...
    isApiUnlocked: false,
    commercialNotes: 'Sociedade de advogados e consultoria jurídica. Foco em retenção na fonte de 6.5%.',
  ...
  },
  {
    ...
    isBatchUnlocked: true,
    isApiUnlocked: false,
    commercialNotes: 'Exportador de Lisboa para os PALOP. Opera sob fiscalidade da Autoridade Tributária (AT).',
...
export const INITIAL_STAFF_USERS: UserSafe[] = [
  ...
  {
    id: 'usr_admin2_02',
    name: 'Dra. Teresa Bento (Diretora Fiscal / Admin Nível 2)',
    email: 'teresa.bento@nanucloud.com',
    role: 'admin_level2',
    department: 'Consultoria Fiscal',
    country: 'Angola',
  ...
  {
    id: 'usr_mgr_03',
    name: 'Carlos Manuel (Gestor Comercial & Contas)',
    ...
    isActive: true,
    queriesRemaining: 20000,
    totalQueriesUsed: 310,
    activePlanId: 'plan_pro',
    activePlanName: 'Licença Gestor de Clientes',
    planExpiresAt: '2026-12-31T23:59:59Z',
    isImportUnlocked: true,
    isBatchUnlocked: true,
    isApiUnlocked: false,
  ...
  {
    id: 'usr_sup_04',
    name: 'Helena Afonso (Agente de Suporte & Tickets)',
    email: 'helena.suporte@nanucloud.com',
    role: 'user',
    department: 'Suporte Técnico',
    country: 'Angola',
    phone: '+244 933 222 111',
    company: 'NANUCLOUD Atendimento',
    permissionGroupId: 'grp_support',
    isActive: true,
    queriesRemaining: 10000,
    totalQueriesUsed: 95,
    activePlanId: 'plan_pro',
    activePlanName: 'Licença Atendimento Suporte',
    planExpiresAt: '2026-12-31T23:59:59Z',
    isImportUnlocked: false,
    isBatchUnlocked: false,
    isApiUnlocked: false,
