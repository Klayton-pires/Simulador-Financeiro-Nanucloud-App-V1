      ...
      <div className="bg-[#1E293B] border border-slate-800 rounded-2xl p-6 shadow-sm">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">
                Formação matemática do PVP de mercadorias, margem de lucro, IVA liquidado, dedução TPA (padrão 0%) e apuramento do lucro líquido real.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4 mb-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  step="any"
                  className={`w-full bg-slate-900 border rounded-lg px-3 py-2 text-xs font-mono focus:border-indigo-500 outline-none transition ${
          ...
          <div className="p-4 bg-[#0F172A] rounded-xl border border-slate-800/80 space-y-3">
            <div className="flex items-center justify-between">
              <label className="text-xs font-bold text-slate-200 font-mono uppercase tracking-wider">
                2. Estratégia de Preço: Margem Desejada (%) OU Preço Fixo (PVP)
              </label>
              <span className="text-[10px] text-slate-400 font-mono">Preencha uma das opções</span>
            </div>
